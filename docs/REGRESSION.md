...
- 实测注记（2026-09-11，B18）：收起态栏偏向其所折叠段的内容一侧——before 栏（正文上方 / 轮首段兜底）`margin:0`，正文行基线到栏标签基线 上方 25px / 下方 9px；after 栏（正文下方）`margin:16px 0 0`，上方 16px / 下方 25px（下方含下一座位的 16px 流程间距）。方向由用户在两轮实现对照后选定。
